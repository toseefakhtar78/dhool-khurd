...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-6 lg:p-8">
      ...
      <p className="mb-4">
        Welcome to Dhoolkhurd! We are committed to protecting your personal
        ...
        our website [Your Website URL] (the Site). Please read this Privacy
      ...
      <p className="mb-4">
        When you visit or use the Site, we may collect personal information that
        you voluntarily provide to us, such as your name, email address, and
        phone number. This information is collected when you fill out forms,
        subscribe to our newsletter, or communicate with us directly.
      </p>

      <h3 className="text-xl font-bold mb-1">2.2 Usage Data</h3>
      <p className="mb-4">
        We collect information automatically when you visit the Site, including
        your IP address, browser type, operating system, referring URLs, pages
        viewed, and the dates and times of your visits. This helps us understand
      ...
      <p className="mb-4">
        ...
        our Site and store certain information. Cookies are small files stored
        on your device that help us remember your preferences and provide a more
        personalized experience. You can manage cookies through your browser
      ...
      <ul className="list-disc pl-4 mb-4">
        ...
        <li>
          To personalize your experience and provide content tailored to your
          interests.
        </li>
        <li>
      ...
      <p className="mb-4">
        {" "}
        Provide information on how users can opt out of personalized advertising
        or disable cookies. Include instructions for opting out of Google
        AdSense or other third-party ad services.
      </p>
      <h1 className="text-2xl font-bold mb-1">Childrens Privacy:</h1>
      <span className="font-bold">COPPA Compliance</span>
      <p className="mb-4">
        {" "}
        If applicable, state that you do not knowingly collect personal
        information from children under 13 (or other relevant age based on local
        regulations).
      </p>
      <h2 className="text-2xl font-bold mb-2">
      ...
      <ul className="list-disc pl-4 mb-4">
        ...
        <li>
          For Legal Reasons: We may disclose your information if required to do
          so by law or in response to legal requests, such as a subpoena or
          court order.
        </li>
        <li>
      ...
      <p className="mb-4">
        Indicate how and when you will notify users about changes to your
        Privacy Policy.
      </p>
      ...
      <p className="mb-4">
        Provide a contact method for users to ask questions or request
        information regarding your Privacy Policy.
      </p>
      <h2 className="text-2xl font-bold mb-2">6. Your Choices and Rights</h2>
      <p className="mb-4">You have the right to:</p>
      <ul className="list-disc pl-4 mb-4">
        <li>
          Access and Update: Access and update your personal information by
          contacting us directly.
        </li>
        <li>
          Opt-Out: Opt-out of receiving marketing communications by following
          the unsubscribe instructions in those communications.
        </li>
        <li>
          Delete: Request the deletion of your personal information, subject to
          certain
        </li>
      </ul>
      ...
      <p className="mb-4 text-sm">
        that we do not sell your personal information to third parties. By using
        our website, you acknowledge that you have read, understood, and agree
        to our privacy policy. You also acknowledge that you cannot challenge or
        dispute this policy in any court of law or through any other means. We
      ...
      <div className="flex flex-col items-center justify-center mb-8 border border-gray-400 p-4 rounded-md">
