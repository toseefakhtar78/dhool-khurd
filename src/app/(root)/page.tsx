  ...
  return (
    <>
      <div className="flex  flex-col items-center justify-between p-10 ">
        ...
        <p className="mt-6 text-2xl font-mono font-bold">( The Digital Village )</p>
      ...
      <h1 className="text-center mb-4 text-xl font-bold font-mono ">Here is where we live :</h1>
      {/* <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap"> */}
      <div className="relative bg-gray-900 rounded-lg overflow-hidden p-4 sm:p-6 lg:p-10 flex items-center justify-center lg:w-2/3 md:w-1/2 mx-auto">
  <iframe
    width="100%"
    height="100%"
    title="map"
    className="lg:absolute inset-0 w-full h-full"
